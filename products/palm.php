...
<header>
	...
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active">技术方案</li>
	</ol>
	<!--/model-->
...
<h2 style="font-size:28px">产品中心</h2>
 <ul>
   <li><a href="./index.php">智能光纤报警系统</a></li>
   <li><a href="./palm.php">掌静脉生物识别系统</a></li>
 </ul>
</div>
<div  style="width:80%;float:left">
<a><img src="../XZ-公司网站-TXT-190412.files/image025.png" style="height:20%;width:12%;margin:50px"/></a>
<a><img src="../XZ-公司网站-TXT-190412.files/image026.png" style="height:20%;width:20%;margin:50px"/></a>
<a><img src="../XZ-公司网站-TXT-190412.files/image023.png" style="height:20%;width:20%;margin:50px"/></a><br>
<a style="margin:0px;padding-right:50px">PVS01<a>
<a style="margin:200px;padding-right:150px">PVS02<a>
</div>
</div>
